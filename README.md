...
- Сортировка БД по размеру
 ...
 -k количество хранимых последних дампов БД, после успешного выполнения резервного копирования БД, удалит самые старые дампы оставив указанное количество дампов (по умолчанию 0 - не удаляются)\
